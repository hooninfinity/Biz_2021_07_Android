package com.callor.oneday_movie;
...
import com.callor.oneday_movie.service.impl.NaverMovieServiceImplV1;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        naverMovieService.getMovies("어벤져스");
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setQueryHint("검색어를 입력한 후 검색버튼을 누르세요");
