...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 뒤로가기 버튼 등이 있을때 처리를 쉽게 하기 위한 설정
    ...
    /*
    ActionBar에 메뉴 등을 표현하기 위해 작성되는 코드
...
//            Toast.makeText(MainActivity.this,"설정메뉴클릭", Toast.LENGTH_SHORT).show();
            /*
            ...
            1. content_main.xml 의 fragment view를 NavController로 설정하고
    ...
    /*
    안드로이드의 물리적 버튼
    위로가기, 뒤로가기, 어플종류, 어플리스트 보기 등의 기능을 수행하는 event 핸들러
